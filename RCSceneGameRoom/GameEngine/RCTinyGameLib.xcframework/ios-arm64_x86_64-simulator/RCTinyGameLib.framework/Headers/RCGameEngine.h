 ...
 */
- (void)initWithAppId:(NSString *)appId appKey:(NSString *)appKey config:(RCGameConfig *)gameConfig;
 ...
 */
- (void)switchGame:(NSInteger)gameId gameCallback:(RCGameCallback)gameCallback;
